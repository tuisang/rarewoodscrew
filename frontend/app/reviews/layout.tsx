...
export const metadata: Metadata = {
  title: "Client Reviews & Testimonials | Forge & Timber Atelier",
  description: "Read genuine reviews from our clients across Nairobi. Discover why Forge & Timber is Kenya's premier bespoke furniture atelier.",
