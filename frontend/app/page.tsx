...
export default function HomePage() {
  ...
  const scrollTools = (dir: "left" | "right") => {
    if (toolScrollRef.current) {
      toolScrollRef.current.scrollBy({ left: dir === "right" ? 360 : -360, behavior: "smooth" });
    }
  };
  ...
  return (
    <main className="text-[#e5e2e1] overflow-x-hidden" style={{ position: "relative" }}>
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
            ...
            {HERO_IMAGES.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  height: "8px",
                  background: i === heroIndex ? "#e8bf9b" : "rgba(232,191,155,0.35)",
                  border: "none",
                  cursor: "pointer",
        ...
        <div className="relative z-20 px-4 md:px-16 max-w-[1440px] mx-auto w-full grid grid-cols-1 md:grid-cols-12 gap-6">
          <div className="md:col-span-8 flex flex-col justify-center py-20">
            <span className="text-xs font-medium tracking-[0.2em] text-[#ffb785] mb-4" style={{ fontFamily: "JetBrains Mono, monospace" }}>
              CRAFTED IN NAIROBI
            </span>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/portfolio"
                className="bg-[#e8bf9b] text-[#442b12] px-10 py-4 text-sm font-semibold hover:bg-[#e8bf9b]/90 transition-all flex items-center gap-2 group"
              >
                Explore Creations
              ...
              <Link
                href="/booking"
                className="border border-[#9c8e84] px-10 py-4 text-sm font-semibold hover:bg-[#353535] transition-all"
              >
                Book Consultation
              </Link>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
            ...
            <div className="relative p-1 bg-gradient-to-br from-[#e8bf9b]/30 to-transparent">
              <div className="bg-[#2a2a2a] p-8 border border-[rgba(156,142,132,0.2)]">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-xs text-[#ffb785] tracking-widest" style={{ fontFamily: "JetBrains Mono, monospace" }}>
                ...
                <p className="text-[#d3c4b9] mb-8 leading-relaxed">
                  Our proprietary RAG-powered intelligence is trained on decades of fabrication data, timber species characteristics, and structural engineering principles.
                </p>
                <div className="space-y-4 mb-8">
                  {[
                    '"How do I care for oiled Mvule wood?"',
                    '"Calculate load capacity for steel legs."',
                  ].map((q) => (
                ...
                <button className="w-full py-4 border border-[#e8bf9b]/40 text-[#e8bf9b] hover:bg-[#e8bf9b]/10 transition-colors text-sm font-semibold">
          ...
          <div className="md:col-span-7 pl-0 md:pl-12">
            <h3 className="text-4xl md:text-5xl font-bold leading-tight mb-6" style={{ fontFamily: "Playfair Display, serif" }}>
              Precision guided by <br />
              <span className="text-[#e8bf9b] italic">Intelligence</span>.
            </h3>
            <p className="text-lg text-[#d3c4b9] max-w-md leading-relaxed">
              From wood moisture content analysis to stress-testing metal joints, our AI ensures that every piece of furniture is a masterpiece of both art and engineering.
            </p>
          </div>
        </div>
      </section>

      {/* Tool Atelier Section */}
      <section className="bg-[#0e0e0e] py-24">
        <div className="px-4 md:px-16 max-w-[1440px] mx-auto mb-16">
          <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-6">
            <div>
              <span className="text-xs text-[#9c8e84] tracking-widest mb-4 block" style={{ fontFamily: "JetBrains Mono, monospace" }}>
                FABRICATION ESSENTIALS
              </span>
              <h2 className="text-3xl font-semibold" style={{ fontFamily: "Playfair Display, serif" }}>The Tool Atelier</h2>
            </div>
            <div className="flex gap-4">
              <button
                onClick={() => scrollTools("left")}
                className="w-12 h-12 flex items-center justify-center border border-[#9c8e84] hover:bg-[#e8bf9b] hover:border-[#e8bf9b] hover:text-[#442b12] transition-all active:scale-95"
              >
        ...
        <div ref={toolScrollRef} className="flex overflow-x-auto gap-8 px-4 md:px-16 pb-12 no-scrollbar">
          {[
            { id: 101, name: "Mvule Hardwood Plank", priceLabel: "KSh 3,200", price: 3200, badge: "IN STOCK", desc: "Kiln-dried Mvule hardwood plank, 200cm × 30cm × 4cm. Ideal for tabletops and shelving.", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDKZkFB7nfJk6r7jmyQO-AVHnZdP7LJr29ZqN0oN7deW8u-FynV8eH49R4bubmO2QUoz08l5GAEmy704ZORM-htSo6QE8m1XQrNzsO9QWzsBJmHRZ7Y2DBUDqj62PuAbh-lASPFQ57rHdGz29cx9ckkpH4Zq2YmYd9he093plIplw7Okh7gZhohycXc2UdEF5He9qps9SX4cRwWOcjzKRvPvhskTw1ZJOvhJ2O_TXcdFP9WV_YbCCsPzmlJZwtHvC6fiB2l2pwLqsMT" },
            { id: 102, name: "Hand Chisel Set (7-Piece)", priceLabel: "KSh 12,200", price: 12200, badge: null, desc: "Professional chrome-vanadium steel chisels. Perfect for dovetails, mortises, and fine cleanup.", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAkae4jFO215TwwYfODeHibUzdIT93poQklQR7l0P8zAKJpRMrphd1RLJOwiqZy-xIG43qj7Rn4wZY1B-xEwiDdj5dxIBiOxV6hfXiI1_9uOT1B3g9UiclWMt2QY98Ky0fYVZw120vlqsBb7Rk-to7Xwx9zGQz4RYusbCDP6a--8qJ9VojLv0qs89XTqSXVUQLUNxpvx-w75Qa154joDq8hpEG57PiNV463AXjQXgCdEMlFagN5ICB4_yGmw8rXJIh8V8o7OFYn-EjS" },
            { id: 103, name: "Steel Square Tubing 40×40mm", priceLabel: "KSh 4,800", price: 4800, badge: "POPULAR", desc: "Cold-rolled steel square tubing, 2m length. Used in our furniture frames for maximum strength.", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCi0W20K7JdvjhzPhBCsufmbaCx6pdfVSw5SrxgrjXUKLHdiJV1rROV8o8_LKu53mozE401KnCURBw11DWNKdpKPHa0ibFoeGGLzOxpKn3p_Uy1hGqt0MpJ627Qet6f84qC9j_56U52neJQVm47khZxpwk3q_8k5nHvVV65ZKkuMiXOc3WCzvztYLUnDWoafbQ_sQr9gv0TTaPMnqfFtWxan8a0t_id8OOQf1rb0Wxl9U9GlU10hIq1zgaXyXv3I4haAXKje6wpvGEY" },
            { id: 104, name: "Digital Moisture Meter", priceLabel: "KSh 6,400", price: 6400, badge: null, desc: "Ensure your timber is perfectly seasoned before fabrication. Essential for the Kenyan climate.", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAatGztftak76tZ56xv3wcaukQKkuypfaYyWaOP_dvctNFT8YTzx_Bh2vcjjBDqg8ItJaLfkm8Hjen2pOBJLjCHGgA40oRW0i8MigiGEXXpvDA-Wk8dN9C_7HOarMSA3L8rqd8e31I1vLlYGknetLmIwDzNzMuGJPwonDZZwtC96I5L0AX8vsX96M5ur0rNXrcZNcucbtyN7JsrAOPgcVux1THQoy7Y9YdPGOATEykHP1F_bzIS8l74HrTDFgeYIJ2ZCA_bycJuExqO" },
          ].map((tool) => (
            <div
              key={tool.id}
              onClick={() => setSelectedProduct({ id: tool.id, name: tool.name, price: tool.price, priceLabel: tool.priceLabel, img: tool.img })}
              className="min-w-[320px] bg-[#20201f] border-t border-[#c3c7cb]/20 group rounded-xl overflow-hidden cursor-pointer hover:border-[#e8bf9b]/40 border border-transparent transition-all"
            >
              <div className="h-64 overflow-hidden bg-[#353535] relative rounded-t-xl">
                <img
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 rounded-none"
                  src={tool.img}
                  alt={tool.name}
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#131313]/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                  <div className="bg-[#e8bf9b] text-[#442b12] px-4 py-2 text-xs font-bold" style={{ fontFamily: "JetBrains Mono, monospace" }}>
                    QUICK ADD →
                  </div>
                </div>
                {tool.badge && (
                  <div className="absolute top-4 right-4 bg-[#e8bf9b] px-3 py-1 text-[10px] font-medium text-[#442b12]" style={{ fontFamily: "JetBrains Mono, monospace" }}>
                    {tool.badge}
                  </div>
                )}
              </div>
              <div className="p-6">
                <div className="flex justify-between items-start mb-2">
                  <h4 className="text-lg font-semibold" style={{ fontFamily: "Playfair Display, serif" }}>{tool.name}</h4>
                  <span className="text-[#e8bf9b] font-bold text-sm">{tool.priceLabel}</span>
                </div>
                <p className="text-[#d3c4b9] text-sm mb-4 line-clamp-2">{tool.desc}</p>
                <div className="w-full flex items-center justify-center gap-2 py-3 bg-[#131313] border border-[#4f453d] group-hover:border-[#e8bf9b] transition-colors text-sm font-semibold">
      ...
      <section className="py-24 px-4 md:px-16 max-w-[1440px] mx-auto overflow-hidden">
          ...
          {[
            {
              ...
              title: "Steel Framework Evolution",
              views: "24.5k Views",
              videoId: "dQw4w9WgXcQ",
        ...
        {activeVideo && (
          <div
            className="fixed inset-0 bg-[#131313]/90 backdrop-blur-sm z-[100] flex items-center justify-center p-4"
            ...
            >
              ...
              <div className="relative w-full rounded-xl overflow-hidden" style={{ paddingBottom: "56.25%" }}>
                <iframe
                  ...
                  title="Forge & Timber Video"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowFullScreen
                />
              </div>
              <p className="text-center text-xs text-[#9c8e84] mt-4" style={{ fontFamily: "JetBrains Mono, monospace" }}>
                Replace video IDs in page.tsx with your actual YouTube video IDs
              </p>
            </div>
          </div>
        )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-6 h-auto md:h-[800px]">
            ...
            <div className="md:col-span-2 md:row-span-2 relative group overflow-hidden bg-[#20201f] rounded-xl">
              <img
                ...
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAsSq8Nra0r65CDQA_qJi7jyKDhmXniyz0h83suHoWU8t8pxgawS7bC8GAcxqHCTICoby3FB0vF4pfywk_nh4cYsvmgdhl1iHpZnUVbG14vRCVm0qAAEDikuMGETWn9ppi0lqXAh1ghiGmcz4lOU5Asx5NwFn0EDqR72eKOTTiDDQ1ikEOCCpjD8LGrH01SrNZ5FwIPlrHjlCwkk1a3yA3YBWCRyTaLAbgbCXf2cOhntzvxx02CQy9ONbEslKyuHp6LIwMMxjWxk9do"
        ...
        <section className="py-24 bg-[#131313]">
          <div className="px-4 md:px-16 max-w-[1440px] mx-auto">
            <div className="flex justify-between items-end mb-16">
              <div>
                <span className="text-xs text-[#e8bf9b] mb-4 block tracking-widest" style={{ fontFamily: "JetBrains Mono, monospace" }}>CLIENT TESTIMONIALS</span>
                <h2 className="text-3xl font-semibold" style={{ fontFamily: "Playfair Display, serif" }}>What Our Clients Say</h2>
              </div>
              <Link href="/reviews" className="text-xs text-[#e8bf9b] hover:underline hidden md:block" style={{ fontFamily: "JetBrains Mono, monospace" }}>
                VIEW ALL REVIEWS →
              </Link>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {reviews.map((review) => (
                <div key={review.id} className="bg-[#20201f] border border-[#4f453d]/40 p-6 hover:border-[#e8bf9b]/30 transition-colors">
                  <div className="flex gap-1 mb-4">
                    {[1,2,3,4,5].map((s) => (
                      <svg key={s} width="16" height="16" viewBox="0 0 24 24" fill={s <= review.rating ? "#e8bf9b" : "none"} stroke="#e8bf9b" strokeWidth="2">
                        <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
                      </svg>
                    ))}
                  </div>
                  <h3 className="font-semibold mb-3" style={{ fontFamily: "Playfair Display, serif" }}>{review.title}</h3>
                  <p className="text-[#d3c4b9] text-sm leading-relaxed mb-6">&ldquo;{review.body}&rdquo;</p>
            ...
            <div className="text-center mt-8 md:hidden">
              <Link href="/reviews" className="text-xs text-[#e8bf9b]" style={{ fontFamily: "JetBrains Mono, monospace" }}>
                VIEW ALL REVIEWS →
              </Link>
            </div>
          </div>
        ...
        <section className="py-24 bg-[#0e0e0e]">
          <div className="px-4 md:px-16 max-w-[1440px] mx-auto">
            <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-16 gap-6">
              ...
              <Link href="/reviews" className="text-sm text-[#e8bf9b] hover:underline flex items-center gap-2" style={{ fontFamily: "JetBrains Mono, monospace" }}>
                VIEW ALL REVIEWS →
              </Link>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
